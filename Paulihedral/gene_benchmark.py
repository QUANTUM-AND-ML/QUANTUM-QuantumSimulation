...
with open('NaCl.pickle', 'wb') as f:
    pickle.dump(parr, f)
# He2
parr = molecule.gene_molecule_oplist(molecule.He2)
with open('He2.pickle', 'wb') as f:
    pickle.dump(parr, f)
# HF
parr = molecule.gene_molecule_oplist(molecule.HF)
with open('HF.pickle', 'wb') as f:
    pickle.dump(parr, f)
# HCl
parr = molecule.gene_molecule_oplist(molecule.HCl)
with open('HCl.pickle', 'wb') as f:
    pickle.dump(parr, f)
# ClF
parr = molecule.gene_molecule_oplist(molecule.ClF)
with open('ClF.pickle', 'wb') as f:
    pickle.dump(parr, f)
# LiH
parr = molecule.gene_molecule_oplist(molecule.LiH)
with open('LiH.pickle', 'wb') as f:
    pickle.dump(parr, f)
# NH3
parr = molecule.gene_molecule_oplist(molecule.NH3)
with open('NH3.pickle', 'wb') as f:
    pickle.dump(parr, f)
# CH2
parr = molecule.gene_molecule_oplist(molecule.CH2)
with open('CH2.pickle', 'wb') as f:
    pickle.dump(parr, f)